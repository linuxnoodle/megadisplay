...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1955scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1892delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1893toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1893toDelayMillisLRDsOJo(long j) {
        if (Duration.m1727compareToLRDsOJo(j, Duration.INSTANCE.m1831getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1746getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
