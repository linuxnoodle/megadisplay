...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM352constructorimpl = Result.m352constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM352constructorimpl = Result.m352constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1913boximpl(Result.m359isSuccessimpl(objM352constructorimpl) ? ChannelResult.INSTANCE.m1928successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1926closedJP2dKIU(Result.m355exceptionOrNullimpl(objM352constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1908trySendJP2dKIU = sendChannel.mo1908trySendJP2dKIU(e);
        if (objMo1908trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1923isSuccessimpl(sendChannel.mo1908trySendJP2dKIU(e))) {
            return;
        }
