...
public interface SendChannel<E> {
    ...
    Object mo1908trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1923isSuccessimpl(objMo1908trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1917exceptionOrNullimpl = ChannelResult.m1917exceptionOrNullimpl(objMo1908trySendJP2dKIU);
