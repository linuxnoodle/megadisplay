...
public interface ReceiveChannel<E> {
    ...
    Object mo1906receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1907tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1907tryReceivePtdJZtk = receiveChannel.mo1907tryReceivePtdJZtk();
            if (ChannelResult.m1923isSuccessimpl(objMo1907tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1919getOrThrowimpl(objMo1907tryReceivePtdJZtk);
            }
            Throwable thM1917exceptionOrNullimpl = ChannelResult.m1917exceptionOrNullimpl(objMo1907tryReceivePtdJZtk);
            if (thM1917exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1917exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1906receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1918getOrNullimpl(r4)
                return r4
            */
