...
public final class HandlerDispatcherKt {
    ...
    static {
        Object objM352constructorimpl;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM352constructorimpl = Result.m352constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM352constructorimpl = Result.m352constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m358isFailureimpl(objM352constructorimpl) ? null : objM352constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1954dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1904postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1904postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
