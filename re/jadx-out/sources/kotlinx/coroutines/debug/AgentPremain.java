...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM352constructorimpl = Result.m352constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM352constructorimpl = Result.m352constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m358isFailureimpl(objM352constructorimpl) ? null : objM352constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1931installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1931installSignalHandler$lambda1(Signal signal) {
