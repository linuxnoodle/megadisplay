...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM352constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM352constructorimpl = Result.m352constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM352constructorimpl = Result.m352constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m355exceptionOrNullimpl(objM352constructorimpl) == null) {
            obj2 = objM352constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM352constructorimpl2 = Result.m352constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM352constructorimpl2 = Result.m352constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m355exceptionOrNullimpl(objM352constructorimpl2) == null) {
            obj = objM352constructorimpl2;
        }
