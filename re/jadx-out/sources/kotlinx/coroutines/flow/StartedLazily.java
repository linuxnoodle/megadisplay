    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C00121(booleanRef, flowCollector), this) == coroutine_suspended) {
        ...
        static final class C00121<T> implements FlowCollector {
            ...
            C00121(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
            ...
            */
            public final java.lang.Object emit(int r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
                ...
                L51:
                    ...
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C00121.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
            }
