...
public final class zak extends zap {
    ...
    public final void onStart() {
        super.onStart();
        SparseArray sparseArray = this.zad;
        Log.d("AutoManageHelper", "onStart " + this.zaa + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + String.valueOf(sparseArray));
    ...
    public final void zad(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", "starting AutoManage for client " + i + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.zaa + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + String.valueOf(zamVar));
