            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        ResourcesLoader resourcesLoaderM179m = Trace$$ExternalSyntheticApiModelOutline0.m179m();
                        resourcesLoaderM179m.addProvider(ResourcesProvider.loadFromTable(parcelFileDescriptorDup, null));
