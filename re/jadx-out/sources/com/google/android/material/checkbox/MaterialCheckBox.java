...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM184m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM184m = Trace$$ExternalSyntheticApiModelOutline0.m184m(getContext().getSystemService(Trace$$ExternalSyntheticApiModelOutline0.m186m()))) != null) {
                autofillManagerM184m.notifyValueChanged(this);
            }
