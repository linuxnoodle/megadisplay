...
public final class SingleChoiceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public SingleChoiceViewHolder(View itemView, SingleChoiceDialogAdapter adapter) {
        ...
        View viewFindViewById = itemView.findViewById(R.id.md_control);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById, "itemView.findViewById(R.id.md_control)");
        this.controlView = (AppCompatRadioButton) viewFindViewById;
        View viewFindViewById2 = itemView.findViewById(R.id.md_title);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById2, "itemView.findViewById(R.id.md_title)");
