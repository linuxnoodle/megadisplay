...
/* JADX INFO: compiled from: DialogContentLayout.kt */
...
public final class DialogContentLayout extends FrameLayout {
    ...
    /* JADX INFO: renamed from: frameHorizontalMargin$delegate, reason: from kotlin metadata */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < childCount2; i3++) {
            View currentChild = getChildAt(i3);
            ...
            if (dialogScrollView3 == null || id != dialogScrollView3.getId()) {
                if (Intrinsics.areEqual(currentChild, this.customView) && this.useHorizontalPadding) {
                    iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - (getFrameHorizontalMargin() * 2), BasicMeasure.EXACTLY);
                } else {
                    iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY);
                }
                currentChild.measure(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(i2, Integer.MIN_VALUE));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (i < childCount) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(currentChild, "currentChild");
            int measuredHeight = currentChild.getMeasuredHeight() + i2;
            if (Intrinsics.areEqual(currentChild, this.customView) && this.useHorizontalPadding) {
            ...
            currentChild.layout(frameHorizontalMargin, i2, measuredWidth, measuredHeight);
            i++;
            i2 = measuredHeight;
        }
    }
