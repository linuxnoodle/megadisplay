...
/* JADX INFO: compiled from: DialogActionButtonLayout.kt */
...
public final class DialogActionButtonLayout extends BaseSubLayout {
    ...
    /* JADX INFO: renamed from: getStackButtons$core, reason: from getter */
    ...
    protected void onFinishInflate() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById, "findViewById(R.id.md_button_positive)");
        View viewFindViewById2 = findViewById(R.id.md_button_negative);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById2, "findViewById(R.id.md_button_negative)");
        View viewFindViewById3 = findViewById(R.id.md_button_neutral);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById3, "findViewById(R.id.md_button_neutral)");
        ...
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById4, "findViewById(R.id.md_checkbox_prompt)");
        ...
        for (int i = 0; i < length; i++) {
            ...
            final WhichButton whichButtonFromIndex = WhichButton.INSTANCE.fromIndex(i);
            dialogActionButton.setOnClickListener(new View.OnClickListener() { // from class: com.afollestad.materialdialogs.internal.button.DialogActionButtonLayout.onFinishInflate.1
                ...
                public final void onClick(View view) {
                    DialogActionButtonLayout.this.getDialog().onActionButtonClicked$core(whichButtonFromIndex);
                }
            });
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ((!(getVisibleButtons().length == 0)) && !this.stackButtons) {
            ...
            if (measuredWidth >= size && !this.stackButtons) {
                ...
                for (DialogActionButton dialogActionButton3 : getVisibleButtons()) {
                    ...
                    dialogActionButton3.measure(View.MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
                }
            }
        }
        int iRequiredHeightForButtons = requiredHeightForButtons();
        ...
        if (ViewsKt.isVisible(appCompatCheckBox3)) {
            ...
            iRequiredHeightForButtons += appCompatCheckBox4.getMeasuredHeight() + (this.checkBoxPromptMarginVertical * 2);
        }
        setMeasuredDimension(size, iRequiredHeightForButtons);
    }
        ...
        if (DialogActionButtonLayoutKt.shouldBeVisible(this)) {
            ...
            if (ViewsKt.isVisible(appCompatCheckBox)) {
                if (ViewsKt.isRtl(this)) {
                    measuredWidth2 = getMeasuredWidth() - this.checkBoxPromptMarginHorizontal;
                    i = this.checkBoxPromptMarginVertical;
                    AppCompatCheckBox appCompatCheckBox2 = this.checkBoxPrompt;
                    if (appCompatCheckBox2 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("checkBoxPrompt");
                    }
                    measuredWidth = measuredWidth2 - appCompatCheckBox2.getMeasuredWidth();
                    AppCompatCheckBox appCompatCheckBox3 = this.checkBoxPrompt;
                    if (appCompatCheckBox3 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("checkBoxPrompt");
                    }
                    ...
                    measuredWidth = this.checkBoxPromptMarginHorizontal;
                    i = this.checkBoxPromptMarginVertical;
                    AppCompatCheckBox appCompatCheckBox4 = this.checkBoxPrompt;
                    if (appCompatCheckBox4 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("checkBoxPrompt");
                    }
                    measuredWidth2 = appCompatCheckBox4.getMeasuredWidth() + measuredWidth;
                ...
                appCompatCheckBox6.layout(measuredWidth, i, measuredWidth2, i2);
            }
            if (this.stackButtons) {
                int i3 = this.buttonFramePadding;
                int measuredWidth3 = getMeasuredWidth() - this.buttonFramePadding;
                int measuredHeight2 = getMeasuredHeight();
                for (DialogActionButton dialogActionButton : ArraysKt.reversed(getVisibleButtons())) {
                    int i4 = measuredHeight2 - this.buttonFrameSpecHeight;
                    dialogActionButton.layout(i3, i4, measuredWidth3, measuredHeight2);
                    measuredHeight2 = i4;
                }
                return;
            }
            ...
            if (ViewsKt.isRtl(this)) {
                ...
                if (ViewsKt.isVisible(dialogActionButtonArr[2])) {
                    ...
                    int measuredWidth4 = getMeasuredWidth() - this.buttonFramePaddingNeutral;
                ...
                int i5 = this.buttonFramePadding;
                ...
                if (ViewsKt.isVisible(dialogActionButtonArr3[0])) {
                    ...
                    int measuredWidth5 = dialogActionButton3.getMeasuredWidth() + i5;
                    dialogActionButton3.layout(i5, measuredHeight3, measuredWidth5, measuredHeight4);
                    i5 = measuredWidth5;
                }
                ...
                if (ViewsKt.isVisible(dialogActionButtonArr5[1])) {
                    ...
                    dialogActionButton4.layout(i5, measuredHeight3, dialogActionButton4.getMeasuredWidth() + i5, measuredHeight4);
                    return;
                }
                return;
            }
            ...
            if (ViewsKt.isVisible(dialogActionButtonArr7[2])) {
                ...
                int i6 = this.buttonFramePaddingNeutral;
                dialogActionButton5.layout(i6, measuredHeight3, dialogActionButton5.getMeasuredWidth() + i6, measuredHeight4);
            }
            int measuredWidth6 = getMeasuredWidth() - this.buttonFramePadding;
            ...
            if (ViewsKt.isVisible(dialogActionButtonArr9[0])) {
                ...
                int measuredWidth7 = measuredWidth6 - dialogActionButton6.getMeasuredWidth();
                dialogActionButton6.layout(measuredWidth7, measuredHeight3, measuredWidth6, measuredHeight4);
            ...
            if (ViewsKt.isVisible(dialogActionButtonArr11[1])) {
                ...
                dialogActionButton7.layout(measuredWidth6 - dialogActionButton7.getMeasuredWidth(), measuredHeight3, measuredWidth6, measuredHeight4);
            }
        }
    }
