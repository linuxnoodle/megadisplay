...
/* JADX INFO: compiled from: DialogMessageSettings.kt */
...
public final class DialogMessageSettings {
    ...
    public final void setText$core(Integer res, CharSequence text) {
        ...
        CharSequence charSequenceMaybeWrapHtml = maybeWrapHtml(text, this.isHtml);
        if (charSequenceMaybeWrapHtml == null) {
            charSequenceMaybeWrapHtml = MDUtil.resolveString$default(MDUtil.INSTANCE, this.dialog, res, (Integer) null, this.isHtml, 4, (Object) null);
        }
        textView.setText(charSequenceMaybeWrapHtml);
    }
