...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public void writeRaw(String str, int i, int i2) throws IOException {
        ...
        while (i2 > 0) {
            ...
            if (i2 > 0 && (c = cArr[iMin2 - 1]) >= 55296 && c <= 56319) {
                iMin2--;
            }
    ...
    private final void _writeCustomStringSegment2(char[] cArr, int i, int i2) throws IOException {
        ...
        byte[] bArr = this._outputBuffer;
        int[] iArr = this._outputEscapes;
        int i3 = this._maximumNonEscapedChar <= 0 ? SupportMenu.USER_MASK : this._maximumNonEscapedChar;
