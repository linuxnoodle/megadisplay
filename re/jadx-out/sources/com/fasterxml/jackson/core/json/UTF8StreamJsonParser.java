...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    protected final boolean _loadToHaveAtLeast(int i) throws IOException {
        ...
        while (this._inputEnd < i) {
            int i4 = this._inputStream.read(this._inputBuffer, this._inputEnd, this._inputBuffer.length - this._inputEnd);
            if (i4 < 1) {
                _closeInput();
                if (i4 != 0) {
                    return false;
    ...
    */
    ...
    protected int _readBinary(Base64Variant base64Variant, OutputStream outputStream, byte[] bArr) throws IOException {
        ...
        while (true) {
            ...
            if (i4 > 32) {
                ...
                this._inputPtr = i5 + 1;
                int i6 = bArr3[i5] & UByte.MAX_VALUE;
                ...
                if (iDecodeBase64Char3 < 0) {
                    ...
                    if (iDecodeBase64Char3 == -2) {
                        ...
                        int i11 = bArr5[i10] & UByte.MAX_VALUE;
                ...
                int i14 = bArr6[i13] & UByte.MAX_VALUE;
    ...
    protected JsonToken _parseNegNumber() throws IOException {
        ...
        this._inputPtr = i + 1;
        int i_verifyNoLeadingZeroes = bArr[i] & UByte.MAX_VALUE;
    ...
    private final JsonToken _parseNumber2(char[] cArr, int i, boolean z, int i2) throws IOException {
        ...
        if (this._parsingContext.inRoot()) {
            ...
            this._inputPtr = i7 + 1;
            _verifyRootSpace(bArr2[i7] & UByte.MAX_VALUE);
        }
        return resetInt(z, i5);
    }
