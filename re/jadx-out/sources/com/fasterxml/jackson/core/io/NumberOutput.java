...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", "2", "3", "4", "5", AbstractConnection.SENTRY_PROTOCOL_VERSION, "7", "8", "9", "10"};
    ...
    private static int _outputUptoBillion(int i, char[] cArr, int i2) {
        ...
        cArr[i_leading3 + 1] = (char) ((i8 >> 8) & WorkQueueKt.MASK);
        cArr[i_leading3 + 2] = (char) (i8 & WorkQueueKt.MASK);
        int i9 = iArr[i5];
        cArr[i_leading3 + 3] = (char) (i9 >> 16);
        int i10 = i_leading3 + 5;
        cArr[i_leading3 + 4] = (char) ((i9 >> 8) & WorkQueueKt.MASK);
    ...
    private static int _outputFullBillion(int i, char[] cArr, int i2) {
        ...
        int i6 = iArr[i5];
        cArr[i2] = (char) (i6 >> 16);
        cArr[i2 + 1] = (char) ((i6 >> 8) & WorkQueueKt.MASK);
        cArr[i2 + 2] = (char) (i6 & WorkQueueKt.MASK);
        int i7 = iArr[i3 - (i5 * 1000)];
        cArr[i2 + 3] = (char) (i7 >> 16);
        cArr[i2 + 4] = (char) ((i7 >> 8) & WorkQueueKt.MASK);
        cArr[i2 + 5] = (char) (i7 & WorkQueueKt.MASK);
        int i8 = iArr[i4];
        cArr[i2 + 6] = (char) (i8 >> 16);
        int i9 = i2 + 8;
        cArr[i2 + 7] = (char) ((i8 >> 8) & WorkQueueKt.MASK);
        int i10 = i2 + 9;
        cArr[i9] = (char) (i8 & WorkQueueKt.MASK);
        return i10;
    }
