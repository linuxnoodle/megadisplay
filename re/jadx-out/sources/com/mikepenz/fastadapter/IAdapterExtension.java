...
public interface IAdapterExtension<Item extends IItem<? extends RecyclerView.ViewHolder>> {
    ...
    void set(List<? extends Item> items, boolean resetFilter);

    void withSavedInstanceState(Bundle savedInstanceState, String prefix);
}
