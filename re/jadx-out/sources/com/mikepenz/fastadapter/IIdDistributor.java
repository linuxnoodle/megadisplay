...
/* JADX INFO: compiled from: IIdDistributor.kt */
...
public interface IIdDistributor<Identifiable extends IIdentifyable> {
    ...
    List<Identifiable> checkIds(List<? extends Identifiable> identifiables);

    Identifiable[] checkIds(Identifiable... identifiables);
