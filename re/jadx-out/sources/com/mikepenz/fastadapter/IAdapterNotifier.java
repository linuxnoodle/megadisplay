...
/* JADX INFO: compiled from: IAdapterNotifier.kt */
...
public interface IAdapterNotifier {
        ...
        public boolean notify(FastAdapter<?> fastAdapter, int newItemsCount, int previousItemsCount, int itemsBeforeThisAdapter) {
            ...
            if (newItemsCount > previousItemsCount) {
                if (previousItemsCount > 0) {
                    FastAdapter.notifyAdapterItemRangeChanged$default(fastAdapter, itemsBeforeThisAdapter, previousItemsCount, null, 4, null);
                }
                fastAdapter.notifyAdapterItemRangeInserted(itemsBeforeThisAdapter + previousItemsCount, newItemsCount - previousItemsCount);
                return false;
            }
            if (newItemsCount > 0) {
                FastAdapter.notifyAdapterItemRangeChanged$default(fastAdapter, itemsBeforeThisAdapter, newItemsCount, null, 4, null);
                if (newItemsCount >= previousItemsCount) {
                    return false;
                }
    ...
    public static final IAdapterNotifier LEGACY_DEFAULT = new IAdapterNotifier() { // from class: com.mikepenz.fastadapter.IAdapterNotifier$Companion$LEGACY_DEFAULT$1
        ...
        public boolean notify(FastAdapter<?> fastAdapter, int newItemsCount, int previousItemsCount, int itemsBeforeThisAdapter) {
            ...
            if (1 <= newItemsCount && previousItemsCount > newItemsCount) {
                FastAdapter.notifyAdapterItemRangeChanged$default(fastAdapter, itemsBeforeThisAdapter, newItemsCount, null, 4, null);
                fastAdapter.notifyAdapterItemRangeRemoved(itemsBeforeThisAdapter + newItemsCount, previousItemsCount - newItemsCount);
                return false;
            }
