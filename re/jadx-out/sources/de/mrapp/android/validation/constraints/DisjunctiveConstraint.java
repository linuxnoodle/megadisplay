...
public class DisjunctiveConstraint<Type> implements Constraint<Type> {
    ...
    public DisjunctiveConstraint(Constraint<Type>[] constraintArr) {
        setConstraints(constraintArr);
    }

    public static <Type> DisjunctiveConstraint<Type> create(Constraint<Type>[] constraintArr) {
        return new DisjunctiveConstraint<>(constraintArr);
    }
