...
public abstract class AbstractMaterialDialog extends Dialog implements de.mrapp.android.dialog.model.MaterialDialog {
    ...
    private Map<DialogRootView.ViewType, View> attachDecorators(Window window, DialogRootView dialogRootView, View view) {
        HashMap map = new HashMap();
        for (AbstractDecorator abstractDecorator : this.decorators) {
            map.putAll(abstractDecorator.attach(window, view, map, null));
    ...
    protected AbstractMaterialDialog(Context context, int i) {
        super(context, i);
    ...
    protected final void addDecorator(AbstractDecorator abstractDecorator) {
    ...
    public final void onStart() {
        ...
        setContentView(viewInflateLayout);
        ...
        this.rootView.addAreas(attachDecorators(window, dialogRootView, viewInflateLayout));
    }
