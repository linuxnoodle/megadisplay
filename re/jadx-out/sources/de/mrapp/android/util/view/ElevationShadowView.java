...
public class ElevationShadowView extends AppCompatImageView {
    ...
    private void obtainStyledAttributes(AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ElevationShadowView, i, i2);
        try {
            obtainShadowElevation(typedArrayObtainStyledAttributes);
            obtainShadowOrientation(typedArrayObtainStyledAttributes);
            obtainEmulateParallelLight(typedArrayObtainStyledAttributes);
        } finally {
