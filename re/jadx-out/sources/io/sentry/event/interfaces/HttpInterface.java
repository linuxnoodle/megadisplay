...
public class HttpInterface implements SentryInterface {
    ...
    public HttpInterface(HttpServletRequest httpServletRequest, RemoteAddressResolver remoteAddressResolver, String str) {
        ...
        for (Map.Entry entry : httpServletRequest.getParameterMap().entrySet()) {
            this.parameters.put((String) entry.getKey(), Arrays.asList((Object[]) entry.getValue()));
        }
    ...
    public int hashCode() {
        int iHashCode = this.requestUrl.hashCode() * 31;
        String str = this.method;
        return ((iHashCode + (str != null ? str.hashCode() : 0)) * 31) + this.parameters.hashCode();
    }
}
