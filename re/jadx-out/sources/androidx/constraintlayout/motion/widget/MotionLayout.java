...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            String strConcat = MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR.concat(layoutParams.startToStart != -1 ? "SS" : "__");
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + constraintWidget + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + string3);
            }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getLocation() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getName(this) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getName(getContext(), this.mCurrentState) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getName(childAt) + childAt.getLeft() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + childAt.getTop());
        }
    }
