    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i = 0; i < 9; i++) {
                    str = str + this.variable.goalStrengthVector[i] + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
                }
            }
    ...
    */
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numGoals; i++) {
            ...
            str = str + this.accessor + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
        }
        return str;
    }
}
