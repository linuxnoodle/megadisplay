    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatSpinner> {
        ...
        public void readProperties(AppCompatSpinner appCompatSpinner, PropertyReader propertyReader) {
            if (!this.mPropertiesMapped) {
                throw ComponentDialog$$ExternalSyntheticApiModelOutline0.m19m();
            }
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m27m((Object) spinnerAdapter)) {
                    Api23Impl.setDropDownViewTheme(ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m((Object) spinnerAdapter), theme);
