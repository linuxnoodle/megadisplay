...
class PreferenceInflater {
    ...
    private void init(PreferenceManager preferenceManager) {
        ...
        setDefaultPackages(new String[]{Preference.class.getPackage().getName() + FileUtil.SUFFIX_SEPARATOR, SwitchPreference.class.getPackage().getName() + FileUtil.SUFFIX_SEPARATOR});
    }
