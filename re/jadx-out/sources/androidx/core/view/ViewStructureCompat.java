...
public class ViewStructureCompat {
    ...
    public ViewStructure toViewStructure() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m116m(this.mWrappedObj);
    }
    ...
    public void setText(CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setText(HalfKt$$ExternalSyntheticApiModelOutline0.m116m(this.mWrappedObj), charSequence);
        }
    }

    public void setClassName(String str) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setClassName(HalfKt$$ExternalSyntheticApiModelOutline0.m116m(this.mWrappedObj), str);
        }
    }

    public void setContentDescription(CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setContentDescription(HalfKt$$ExternalSyntheticApiModelOutline0.m116m(this.mWrappedObj), charSequence);
        }
    }

    public void setDimens(int i, int i2, int i3, int i4, int i5, int i6) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setDimens(HalfKt$$ExternalSyntheticApiModelOutline0.m116m(this.mWrappedObj), i, i2, i3, i4, i5, i6);
        }
    }
