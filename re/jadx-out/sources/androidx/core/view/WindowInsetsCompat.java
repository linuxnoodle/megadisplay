...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m117m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM117m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM117m = HalfKt$$ExternalSyntheticApiModelOutline0.m(windowInsets);
            } else {
                builderM117m = HalfKt$$ExternalSyntheticApiModelOutline0.m117m();
            }
            this.mPlatBuilder = builderM117m;
        }
