...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m109m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (HalfKt$$ExternalSyntheticApiModelOutline0.m126m((Object) this.mText)) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m110m((Object) this.mText);
        }
        return null;
    }
