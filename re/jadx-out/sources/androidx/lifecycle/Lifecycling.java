...
public final class Lifecycling {
    ...
    private final Constructor<? extends GeneratedAdapter> generatedConstructor(Class<?> klass) {
        try {
            ...
            if (fullPackage.length() != 0) {
                adapterName = fullPackage + FileUtil.SUFFIX_SEPARATOR_CHAR + adapterName;
            }
    ...
    public static final String getAdapterName(String className) {
        ...
        return StringsKt.replace$default(className, FileUtil.SUFFIX_SEPARATOR, "_", false, 4, (Object) null) + "_LifecycleAdapter";
    }
}
