...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
    ...
    public long getValue() {
        ...
        if (i <= this.memSize - 4) {
            jRotateLeft2 = (Long.rotateLeft(jRotateLeft2 ^ ((((long) SafeUtils.readIntLE(this.memory, i)) & ExpandableGridView.PACKED_POSITION_VALUE_NULL) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i += 4;
        }
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        while (i3 <= i5) {
            jRotateLeft = Long.rotateLeft(jRotateLeft + (SafeUtils.readLongLE(bArr, i3) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            jRotateLeft2 = Long.rotateLeft(jRotateLeft2 + (SafeUtils.readLongLE(bArr, i3 + 8) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            jRotateLeft3 = Long.rotateLeft(jRotateLeft3 + (SafeUtils.readLongLE(bArr, i3 + 16) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            jRotateLeft4 = Long.rotateLeft(jRotateLeft4 + (SafeUtils.readLongLE(bArr, i3 + 24) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i3 += 32;
        }
        this.v1 = jRotateLeft;
