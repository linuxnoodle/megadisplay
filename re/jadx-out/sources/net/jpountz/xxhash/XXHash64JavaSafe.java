...
final class XXHash64JavaSafe extends XXHash64 {
    ...
    public long hash(byte[] bArr, int i, int i2, long j) {
        ...
        if (i2 >= 32) {
            ...
            long j8 = j;
            while (true) {
                jRotateLeft2 = Long.rotateLeft(j7 + (SafeUtils.readLongLE(bArr, i4) * j3), 31) * j4;
                i3 = i5;
                jRotateLeft3 = Long.rotateLeft(j6 + (SafeUtils.readLongLE(bArr, i4 + 8) * j3), 31) * j4;
                jRotateLeft4 = Long.rotateLeft((SafeUtils.readLongLE(bArr, i4 + 16) * (-4417276706812531889L)) + j8, 31) * (-7046029288634856825L);
                jRotateLeft5 = Long.rotateLeft(j5 + (SafeUtils.readLongLE(bArr, i4 + 24) * (-4417276706812531889L)), 31);
        ...
        while (i4 <= i3 - 8) {
            jRotateLeft6 = (Long.rotateLeft(jRotateLeft6 ^ (Long.rotateLeft(SafeUtils.readLongLE(bArr, i4) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i4 += 8;
        }
        if (i4 <= i3 - 4) {
            jRotateLeft6 = (Long.rotateLeft(jRotateLeft6 ^ ((((long) SafeUtils.readIntLE(bArr, i4)) & ExpandableGridView.PACKED_POSITION_VALUE_NULL) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i4 += 4;
        }
        int i7 = i3;
        while (i4 < i7) {
            jRotateLeft6 = Long.rotateLeft(jRotateLeft6 ^ (((long) (SafeUtils.readByte(bArr, i4) & UByte.MAX_VALUE)) * 2870177450012600261L), 11) * (-7046029288634856825L);
            i4++;
        }
