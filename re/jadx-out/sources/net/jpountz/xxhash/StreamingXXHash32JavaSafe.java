...
final class StreamingXXHash32JavaSafe extends AbstractStreamingXXHash32Java {
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        while (i <= i4) {
            ...
            iRotateLeft2 = Integer.rotateLeft(iRotateLeft2 + (SafeUtils.readIntLE(bArr, i + 4) * (-2048144777)), 13) * (-1640531535);
            iRotateLeft3 = Integer.rotateLeft(iRotateLeft3 + (SafeUtils.readIntLE(bArr, i + 8) * (-2048144777)), 13) * (-1640531535);
