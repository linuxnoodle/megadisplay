    ...
    public int hash(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i2 >= 16) {
            ...
            do {
                ...
                iRotateLeft3 = Integer.rotateLeft(iRotateLeft3 + (UnsafeUtils.readIntLE(bArr, i + 4) * (-2048144777)), 13) * (-1640531535);
        ...
        while (i <= i4 - 4) {
            iRotateLeft5 = Integer.rotateLeft(iRotateLeft5 + (UnsafeUtils.readIntLE(bArr, i) * (-1028477379)), 17) * 668265263;
            i += 4;
        }
        while (i < i4) {
            iRotateLeft5 = Integer.rotateLeft(iRotateLeft5 + ((UnsafeUtils.readByte(bArr, i) & UByte.MAX_VALUE) * 374761393), 11) * (-1640531535);
            i++;
        }
