...
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + str + FileUtil.SUFFIX_SEPARATOR + str2)));
    }
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + str + FileUtil.SUFFIX_SEPARATOR + str2)));
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        return "Parameter specified as non-null is null: method " + stackTraceElement.getClassName() + FileUtil.SUFFIX_SEPARATOR + stackTraceElement.getMethodName() + ", parameter " + str;
    }
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        String strReplace = str.replace('/', FileUtil.SUFFIX_SEPARATOR_CHAR);
        try {
