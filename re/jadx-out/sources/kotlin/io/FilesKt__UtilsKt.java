...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final File createTempDir(String prefix, String str, File file) throws IOException {
        ...
        throw new IOException("Unable to create temporary directory " + dir + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final String getExtension(File file) {
        ...
        return StringsKt.substringAfterLast(name, FileUtil.SUFFIX_SEPARATOR_CHAR, "");
    }
    ...
    public static final String getNameWithoutExtension(File file) {
        ...
        String name = file.getName();
        Intrinsics.checkNotNullExpressionValue(name, "name");
        return StringsKt.substringBeforeLast$default(name, FileUtil.SUFFIX_SEPARATOR, (String) null, 2, (Object) null);
    }
    ...
    public static final String toRelativeString(File file, File base) {
        ...
        throw new IllegalArgumentException("this and base files have different roots: " + file + " and " + base + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            String name = file.getName();
            if (!Intrinsics.areEqual(name, FileUtil.SUFFIX_SEPARATOR)) {
