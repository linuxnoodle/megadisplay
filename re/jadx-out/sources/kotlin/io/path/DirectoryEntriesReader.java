...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(PathNode directoryNode) throws IOException {
        ...
        Files.walkFileTree(directoryNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1573m((Object) this));
