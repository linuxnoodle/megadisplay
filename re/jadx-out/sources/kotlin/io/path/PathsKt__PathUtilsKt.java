...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt.substringBeforeLast$default(string, FileUtil.SUFFIX_SEPARATOR, (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
    ...
    public static final String getExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringAfterLast = StringsKt.substringAfterLast(string, FileUtil.SUFFIX_SEPARATOR_CHAR, "")) == null) ? "" : strSubstringAfterLast;
    }
    ...
    public static final Void fileAttributeViewNotAvailable(Path path, Class<?> attributeViewClass) {
        ...
        throw new UnsupportedOperationException("The desired attribute view type " + attributeViewClass + " is not available for the file " + path + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        return (A) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1582m((Object) attributes);
    }
