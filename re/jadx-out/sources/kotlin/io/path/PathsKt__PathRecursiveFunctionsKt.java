...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path3), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1598m$2();
            throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1575m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if ((!z2 || !Files.isSameFile(path, target)) && Intrinsics.areEqual(path.getFileSystem(), target.getFileSystem()) && (!z2 ? !((parent = target.getParent()) == null || !Files.exists(parent, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) || !parent.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0]))) : target.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0])))) {
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1584m();
        ...
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1582m((Object) basicFileAttributes));
                }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path4, IOException iOException) {
                        return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path4), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                AnonymousClass3(Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, Path path, Path path2) {
                    super(2, Intrinsics.Kotlin.class, MirrorActivity.RESULT_EXTRA_ERROR, "copyToRecursively$error$PathsKt__PathRecursiveFunctionsKt(Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;", 0);
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m((Object) path), exc);
                }
    ...
    */
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) throws java.io.IOException {
        /*
            ...
            if (r4 == 0) goto L47
            java.nio.file.DirectoryStream r5 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1565m(r4)     // Catch: java.lang.Throwable -> L13
            goto L15
        L13:
            r5 = r3
        L15:
            ...
            boolean r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1587m(r6)     // Catch: java.lang.Throwable -> L40
            if (r7 == 0) goto L37
            r0.setPath(r4)     // Catch: java.lang.Throwable -> L40
            java.nio.file.SecureDirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1578m(r6)     // Catch: java.lang.Throwable -> L40
            java.nio.file.Path r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1577m(r8)     // Catch: java.lang.Throwable -> L40
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream secureDirectoryStreamM1578m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1578m((Object) secureDirectoryStream2);
            Iterator it = secureDirectoryStreamM1578m.iterator();
            while (it.hasNext()) {
                Path fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "entry.fileName");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM1578m, fileName, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1581m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            while (it.hasNext()) {
                Path entry = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1576m(it.next());
