...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    private final Object yieldIfNeeded(SequenceScope<? super Path> sequenceScope, PathNode pathNode, DirectoryEntriesReader directoryEntriesReader, Function1<? super List<PathNode>, Unit> function1, Continuation<? super Unit> continuation) throws FileSystemLoopException {
        ...
        if (Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (!PathTreeWalkKt.createsCycle(pathNode)) {
                ...
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1595m$1();
                throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1569m(path.toString());
            }
    ...
    static final class C00911 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00911 c00911 = PathTreeWalk.this.new C00911(continuation);
            c00911.L$0 = obj;
            return c00911;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r19) throws java.nio.file.FileSystemLoopException {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.io.path.PathTreeWalk.C00911.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    private final Iterator<Path> dfsIterator() {
        return SequencesKt.iterator(new C00911(null));
    }
