...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1868boximpl(m1862markNowz9LOYto());
    }
    ...
    public long m1862markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1871constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1861elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1860differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m1859adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1871constructorimpl(LongSaturatedMathKt.m1857saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
