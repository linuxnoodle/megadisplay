...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1718elapsedNowUwyO8pc() {
            return Duration.m1763minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1721plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1764plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1720minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1733equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1760isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1831getZEROUwyO8pc();
                    }
                    long jM1763minusLRDsOJo = Duration.m1763minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1733equalsimpl0(duration, Duration.m1781unaryMinusUwyO8pc(jM1763minusLRDsOJo)) ? Duration.INSTANCE.m1831getZEROUwyO8pc() : Duration.m1764plusLRDsOJo(duration, jM1763minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1733equalsimpl0(mo1720minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1831getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1756hashCodeimpl(Duration.m1764plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1777toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1831getZEROUwyO8pc(), null);
    }
}
