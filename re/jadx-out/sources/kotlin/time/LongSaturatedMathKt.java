...
public final class LongSaturatedMathKt {
    ...
    public static final long m1857saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM1774toLongimpl = Duration.m1774toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1856checkInfiniteSumDefinedPjuGub4(j, j2, jM1774toLongimpl);
        }
        if ((1 | (jM1774toLongimpl - 1)) == Long.MAX_VALUE) {
            return m1858saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM1774toLongimpl;
        return ((j ^ j3) & (jM1774toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* JADX INFO: renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m1856checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1760isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m1858saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM1731divUwyO8pc = Duration.m1731divUwyO8pc(j2, 2);
        long jM1774toLongimpl = Duration.m1774toLongimpl(jM1731divUwyO8pc, durationUnit);
        return (1 | (jM1774toLongimpl - 1)) == Long.MAX_VALUE ? jM1774toLongimpl : m1857saturatingAddNuflL3o(m1857saturatingAddNuflL3o(j, durationUnit, jM1731divUwyO8pc), durationUnit, Duration.m1763minusLRDsOJo(j2, jM1731divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        Duration.Companion companion = Duration.INSTANCE;
        return j < 0 ? companion.m1830getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m1829getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1781unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2, DurationUnit unit) {
        ...
        if (((j2 - 1) | 1) == Long.MAX_VALUE) {
            if (j == j2) {
                return Duration.INSTANCE.m1831getZEROUwyO8pc();
            }
            return Duration.m1781unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m1764plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m1781unaryMinusUwyO8pc(infinityOfSign(j3));
        }
