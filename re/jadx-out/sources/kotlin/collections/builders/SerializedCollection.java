...
public final class SerializedCollection implements Externalizable {
    ...
    public void readExternal(ObjectInput input) throws InvalidObjectException {
        ...
        int i = b & 1;
        if ((b & (-2)) != 0) {
            throw new InvalidObjectException("Unsupported flags value: " + ((int) b) + FileUtil.SUFFIX_SEPARATOR_CHAR);
        }
        int i2 = input.readInt();
        if (i2 < 0) {
            throw new InvalidObjectException("Illegal size value: " + i2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
        }
        int i3 = 0;
        if (i == 0) {
            ...
            throw new InvalidObjectException("Unsupported collection type tag: " + i + FileUtil.SUFFIX_SEPARATOR_CHAR);
        }
