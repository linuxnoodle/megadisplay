...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    ...
    private final int versionOf(int major, int minor, int patch) {
        ...
        throw new IllegalArgumentException(("Version components are out of range: " + major + FileUtil.SUFFIX_SEPARATOR_CHAR + minor + FileUtil.SUFFIX_SEPARATOR_CHAR + patch).toString());
    }
