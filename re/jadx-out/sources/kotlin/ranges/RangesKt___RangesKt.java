...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, T t2, T t3) {
        ...
        if (t2 != null && t3 != null) {
            if (t2.compareTo(t3) > 0) {
                throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + t3 + " is less than minimum " + t2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
            }
            if (t.compareTo(t2) < 0) {
                return t2;
            }
    ...
    public static final byte coerceIn(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) b3) + " is less than minimum " + ((int) b2) + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final short coerceIn(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) s3) + " is less than minimum " + ((int) s2) + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final int coerceIn(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + i3 + " is less than minimum " + i2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final long coerceIn(long j, long j2, long j3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + j3 + " is less than minimum " + j2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final float coerceIn(float f, float f2, float f3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + f3 + " is less than minimum " + f2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
    ...
    public static final double coerceIn(double d, double d2, double d3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + d3 + " is less than minimum " + d2 + FileUtil.SUFFIX_SEPARATOR_CHAR);
    }
